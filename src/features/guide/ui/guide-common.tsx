...
import { DateRangePicker, type DateRangeString } from '@/components/date-range-picker'
          ...
          <div className="space-y-4">
            <div className="space-y-6 rounded-xl border bg-white p-6">
              ...
              <div className="grid grid-cols-1 gap-6 border-t pt-6 md:grid-cols-2">
                <div className="space-y-2">
                  <Label>단일 날짜 선택 (Date Picker)</Label>
                  <DatePicker value={date} onChange={setDate} />
                </div>
                <div className="space-y-2">
                  <Label>기간 선택 (Date Range Picker)</Label>
...
const formsCode = `
<span style="color:#6a9955">// Date Picker State</span>
<span style="color:#569cd6">const</span> [<span style="color:#4fc1ff">date</span>, <span style="color:#dcdcaa">setDate</span>] = <span style="color:#dcdcaa">useState</span><span style="color:#808080">&lt;</span><span style="color:#4ec9b0">string</span><span style="color:#808080">&gt;()</span>
<span style="color:#569cd6">const</span> [<span style="color:#4fc1ff">dateRange</span>, <span style="color:#dcdcaa">setDateRange</span>] = <span style="color:#dcdcaa">useState</span><span style="color:#808080">&lt;</span><span style="color:#4ec9b0">DateRangeString</span><span style="color:#808080">&gt;()</span>

<span style="color:#6a9955">{/* Date Picker Components */}</span>
<span style="color:#808080">&lt;</span><span style="color:#569cd6">div</span> <span style="color:#9cdcfe">className</span>=<span style="color:#ce9178">"grid grid-cols-1 gap-6 md:grid-cols-2"</span><span style="color:#808080">&gt;</span>
  <span style="color:#808080">&lt;</span><span style="color:#569cd6">div</span> <span style="color:#9cdcfe">className</span>=<span style="color:#ce9178">"space-y-2"</span><span style="color:#808080">&gt;</span>
    <span style="color:#808080">&lt;</span><span style="color:#4ec9b0">Label</span><span style="color:#808080">&gt;</span>단일 날짜 선택<span style="color:#808080">&lt;/</span><span style="color:#4ec9b0">Label</span><span style="color:#808080">&gt;</span>
    <span style="color:#808080">&lt;</span><span style="color:#4ec9b0">DatePicker</span> <span style="color:#9cdcfe">value</span>={date} <span style="color:#9cdcfe">onChange</span>={setDate} <span style="color:#808080">/&gt;</span>
  <span style="color:#808080">&lt;/</span><span style="color:#569cd6">div</span><span style="color:#808080">&gt;</span>
  <span style="color:#808080">&lt;</span><span style="color:#569cd6">div</span> <span style="color:#9cdcfe">className</span>=<span style="color:#ce9178">"space-y-2"</span><span style="color:#808080">&gt;</span>
    <span style="color:#808080">&lt;</span><span style="color:#4ec9b0">Label</span><span style="color:#808080">&gt;</span>기간 선택<span style="color:#808080">&lt;/</span><span style="color:#4ec9b0">Label</span><span style="color:#808080">&gt;</span>
    <span style="color:#808080">&lt;</span><span style="color:#4ec9b0">DateRangePicker</span> <span style="color:#9cdcfe">value</span>={dateRange} <span style="color:#9cdcfe">onChange</span>={setDateRange} <span style="color:#808080">/&gt;</span>
  <span style="color:#808080">&lt;/</span><span style="color:#569cd6">div</span><span style="color:#808080">&gt;</span>
<span style="color:#808080">&lt;/</span><span style="color:#569cd6">div</span><span style="color:#808080">&gt;</span>

<span style="color:#6a9955">{/* Basic Form Inputs */}</span>
<span style="color:#808080">&lt;</span><span style="color:#569cd6">div</span> <span style="color:#9cdcfe">className</span>=<span style="color:#ce9178">"grid grid-cols-1 gap-6 md:grid-cols-2"</span><span style="color:#808080">&gt;</span>
  <span style="color:#808080">&lt;</span><span style="color:#569cd6">div</span> <span style="color:#9cdcfe">className</span>=<span style="color:#ce9178">"space-y-2"</span><span style="color:#808080">&gt;</span>
